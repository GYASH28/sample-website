...
// that scrolls every product in one pass can include decode work. Keep a firm
// ceiling that still catches runaway script work without penalising fidelity.
const MAX_SCROLL_LONG_TASK_MS = 1800;
