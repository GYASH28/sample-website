...
export function productJsonLd(product, canonicalUrl) {
  ...
  return {
    ...
    additionalProperty: [
      product.variants ? { "@type": "PropertyValue", name: "Variants", value: product.variants } : null,
      product.suitableFor ? { "@type": "PropertyValue", name: "Suitable for", value: product.suitableFor } : null,
    ].filter(Boolean),
    offers: {
      "@type": "Offer",
      priceCurrency: "INR",
